...
export class UserService {
  ...
  async getAllUsers(workspaceId: string, options?: {
    email?: string;
    name?: string;
  ...
  async updateUser(workspaceId: string, userId: string, data: {
    name?: string;
    email?: string;
    timeZone?: string;
    weekStart?: string;
  ...
  async setUserActiveStatus(workspaceId: string, userId: string, active: boolean): Promise<ClockifyUser> {
    return this.client.put<ClockifyUser>(
      `/workspaces/${workspaceId}/users/${userId}/status`, 
