...
export class ReportService {
  ...
  async getSummaryReport(workspaceId: string, request: ClockifyReportRequest): Promise<ClockifyReportResponse> {
  ...
  async getDetailedReport(workspaceId: string, request: ClockifyReportRequest & {
    detailedFilter?: {
      page?: number;
      pageSize?: number;
      sortColumn?: string;
  ...
  async getWeeklyReport(workspaceId: string, request: {
  ...
  async exportReport(workspaceId: string, format: "CSV" | "PDF" | "EXCEL", request: ClockifyReportRequest): Promise<any> {
    const exportRequest = {
      ...request,
      exportType: format
    };
    ...
    return this.client.post(
      `/workspaces/${workspaceId}/reports/summary/export`,
      exportRequest
    );
  }

  async getUserProductivityReport(workspaceId: string, userId: string, dateRange: {
    start: string;
    end: string;
  }): Promise<any> {
  ...
  async getProjectProgressReport(workspaceId: string, projectId: string, dateRange: {
    start: string;
    end: string;
  }): Promise<any> {
    return this.getSummaryReport(workspaceId, {
  ...
  async getClientBillingReport(workspaceId: string, clientId: string, dateRange: {
    start: string;
    end: string;
  }): Promise<any> {
    return this.getSummaryReport(workspaceId, {
  ...
  async getTeamUtilizationReport(workspaceId: string, dateRange: {
    start: string;
    end: string;
  }): Promise<any> {
    return this.getSummaryReport(workspaceId, {
  ...
  async getTagAnalysisReport(workspaceId: string, tagIds: string[], dateRange: {
    start: string;
    end: string;
  }): Promise<any> {
    return this.getSummaryReport(workspaceId, {
